      ...
      <div className="max-w-screen-xl m-auto grid grid-cols-2 bg-white border border-gray-250">
          ...
          <div className="w-full px-10 pb-10">
            <Slider {...settings}>
              <div className="px-3 over">
                <Link className="group" href={"/Product-Details"}>
                  <Image
        ...
        <div className="flex flex-col justify-between p-10">
          ...
          <div className="flex items-center">
            ...
            <Link
              className="text-[14px] mr-5 text-black hover:text-[#7BAE00] transition duration-300"
              href={"/Shop"}
            >
              Cover,{" "}
            </Link>
          ...
          <div className="flex items-center">
            ...
            <Link
              className="h-6 w-6 rounded-full bg-[#FF0000] border-0 hover:border-[3px] border-black ml-4"
              href={"/Product-Details"}
            ></Link>
            <Link
              className="h-6 w-6 rounded-full bg-[#008000] border-0 hover:border-[3px] border-black ml-4"
              href={"/Product-Details"}
            ></Link>
            <Link
              className="h-6 w-6 rounded-full bg-[#0000FF] border-0 hover:border-[3px] border-black ml-4"
              href={"/Product-Details"}
            ></Link>
            <Link
              className="h-6 w-6 rounded-full bg-[#FFFF00] border-0 hover:border-[3px] border-black ml-4"
              href={"/Product-Details"}
            ></Link>
            <Link
              className="h-6 w-6 rounded-full bg-[#FFA500] border-0 hover:border-[3px] border-black ml-4"
              href={"/Product-Details"}
            ></Link>
          </div>
          <div>
            ...
            <Link
              href={"Product-Details"}
              className="text-gray-600 hover:text-[#7BAE00] text-[13px] border-2 border-gray-300 hover:border-[#7BAE00] transition duration-300 ml-1 py-1 px-2 rounded"
            >
              Small
            </Link>
            <Link
          ...
          <div className="flex items-center">
            ...
            <Link
              className="py-[12.5px] px-[30px] flex items-center justify-center bg-[#7BAE00] hover:bg-[#0B2B3C] text-white transition duration-300"
              href={"/Cart"}
            >
