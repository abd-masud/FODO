      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <Image
            ...
            alt=""
          />
          <button className="py-3 px-8 bg-white text-black hover:bg-[#7BAE00] hover:text-white transition absolute mt-24 duration-300 opacity-0 group-hover:opacity-100 z-50">
